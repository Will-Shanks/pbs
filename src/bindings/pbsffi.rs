...
pub struct _IO_marker {
    ...
    #[doc = " If _pos >= 0"]
    #[doc = "it points to _buf->Gbase()+_pos. FIXME comment */"]
...
#[doc = "unless there is an error.  Return number of bytes written.  If"]
#[doc = "there is an error, return 0 and do not write anything.  If the file"]
#[doc = "has been opened for append (__mode.__append set), then set the file"]
#[doc = "pointer to the end of the file and then do the write; if not, just"]
#[doc = "write at the current file pointer."]
...
#[doc = "beginning of the file (if W is SEEK_SET),"]
#[doc = "the current position (if W is SEEK_CUR),"]
#[doc = "or the end of the file (if W is SEEK_END)."]
#[doc = "Set *POS to the new file position."]
#[doc = "Returns zero if successful, nonzero if not."]
...
extern "C" {
    ...
    #[doc = "The result / CLOCKS_PER_SECOND is program time in seconds."]
...
#[doc = "(almost) opaque type for the user level programs.  The file and"]
#[doc = "this data structure is not standardized.  Don't rely on it.  It can"]
#[doc = "go away without warning."]
#[repr(C)]
#[derive(Debug)]
...
extern "C" {
    ...
    #[doc = "This call is restricted to the superuser."]
...
#[doc = " interchangably.  The op field is not used."]
#[repr(C)]
#[derive(Debug)]
pub struct attrl {
    pub next: *mut attrl,
...
#[doc = " and the associated errcode and errmsg"]
#[repr(C)]
#[derive(Debug)]
